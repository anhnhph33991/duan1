                                            ...
                                            <td>
                                                <div class="btn-group dropleft">
                                                    ...
                                                    <div class="dropdown-menu dropleft" x-placement="left-start" style="position: absolute; transform: translate3d(-202px, 0px, 0px); top: 0px; left: 0px; will-change: transform; border: 1px solid black;">
                                                        ...
                                                        <a class="dropdown-item" href="<?= BASE_URL_ADMIN ?>?act=delete-product&id=<?= $value['p_id'] ?>" onclick="handleDelete(e ,<?= $value['p_id'] ?>)"><i class="fa-solid fa-trash" style="color: #f50529;"></i><span style="margin-left: 0.5rem">Delete</span></a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
