<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">Update Vouchers</div>
        </div>
    </div>

    <div class="section-body ">
        <h2 class="section-title">Update Comment</h2>
        <form class="row" action="" method="post" enctype="multipart/form-data">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Update Your Voucher</h4>
                    </div>
                    <div class="card-body">
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Voucher Code</label>
                            <div class="col-sm-12 col-md-7">
                                <input type="text" class="form-control <?= !empty($_SESSION['errors']['code']) ? 'is-invalid' : '' ?>" name="code" value="<?= $voucher['voucher_code'] ?>">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" class="form-control <?= !empty($_SESSION['errors']['value']) ? 'is-invalid' : '' ?>" name="value" value="<?= $voucher['value'] ?>">
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <textarea class="summernote-simple" name="desc">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" class="form-control <?= !empty($_SESSION['errors']['qty']) ? 'is-invalid' : '' ?>" name="qty" value="<?= $voucher['qty'] ?>">
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <button class="btn btn-primary" name="submit">Update Voucher</button>
                            </div>
                        </div>
                    </div>
                </div>
