    ...
    <div class="container">
        <div class="row small-gutters">
            <div class="col-xl-3 col-lg-3 d-lg-flex align-items-center">
                <div id="logo">
                    <a href="<?= BASE_URL ?>"><img src="<?= BASE_URL ?>public/assets/img/logo.svg" alt="" width="100" height="35"></a>
                </div>
            </div>
            <nav class="col-xl-6 col-lg-7">
                ...
                <div class="main-menu">
                    <div id="header_menu">
                        <a href="index.html"><img src="<?= BASE_URL ?>public/assets/img/logo_black.svg" alt="" width="100" height="35"></a>
                                ...
                                <div class="row small-gutters">
                                    ...
                                    <div class="col-lg-3 d-xl-block d-lg-block d-md-none d-sm-none d-none">
                                        <div class="banner_menu">
                                            <a href="#0">
                                                <img src="<?= BASE_URL ?>public/assets/img/banner_menu.jpg" data-src="<?= BASE_URL ?>public/assets/img/banner_menu.jpg" width="400" height="550" alt="" class="img-fluid lazy">
                                            </a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="col-xl-3 col-lg-2 d-lg-flex align-items-center justify-content-end text-end">
                <a class="phone_top" href="tel://9438843343"><strong><span>Bạn cần giúp đỡ ?</span>0362753666</strong></a>
            </div>
        </div>
        <!-- /row -->
    </div>
                        ...
                        <div class="dropdown dropdown-cart">
                            ...
                            <div class="dropdown-menu">
                                <ul>
                                    <li>
                                        <a href="product-detail-1.html">
                                            <figure><img src="<?= BASE_URL ?>public/assets/img/products/product_placeholder_square_small.jpg" data-src="<?= BASE_URL ?>public/assets/img/products/shoes/thumb/1.jpg" alt="" width="50" height="50" class="lazy"></figure>
                                    ...
                                    <li>
                                        <a href="product-detail-1.html">
                                            <figure><img src="<?= BASE_URL ?>public/assets/img/products/product_placeholder_square_small.jpg" data-src="<?= BASE_URL ?>public/assets/img/products/shoes/thumb/2.jpg" alt="" width="50" height="50" class="lazy"></figure>
                                ...
                                <div class="total_drop">
                                    ...
                                    <a href="<?= BASE_URL ?>?act=cart" class="btn_1 outline">View Cart</a>
                                    <a href="<?= BASE_URL ?>?act=checkout" class="btn_1">Checkout</a>
                                </div>
                            </div>
                        </div>
                        <!-- /dropdown-cart-->
                        ...
                        <div class="dropdown dropdown-access">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <?php if (!empty($_SESSION['user'])) :  ?>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="<?= BASE_URL ?>?act=check-your-order"><i class="ti-truck"></i>Track your Order</a>
                                        </li>
                                        <li>
                                            <a href="<?= BASE_URL ?>?act=my-order"><i class="ti-package"></i>My Orders</a>
                                        </li>
                                        <li>
                                            <a href="<?= BASE_URL ?>?act=my-profile"><i class="ti-user"></i>My Profile</a>
                                        </li>
                                        <li>
                                            <a href="<?= BASE_URL ?>?act=logout">
                                                <!-- Style riêng cho icon lib remixIcon -->
                                                <i class="ri-logout-box-r-line" style="top: 9px;"></i>
                                                Logout
                                            </a>
                                        </li>
                                    </ul>
