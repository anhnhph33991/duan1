        ...
        <div class="row">
            <div class="col-md-4">
                <div class="item_panel">
                    <a href="#0">
                        <figure>
                            <img src="<?= BASE_URL ?>public/assets/img/products/product_placeholder_square_small.jpg" data-src="<?= BASE_URL ?>public/assets/img/products/shoes/2.jpg" alt="" class="lazy">
                        </figure>
                    </a>
                    <a href="#0">
            ...
            <div class="col-md-4">
                <div class="item_panel">
                    <a href="#0">
                        <figure>
                            <img src="<?= BASE_URL ?>public/assets/img/products/product_placeholder_square_small.jpg" data-src="<?= BASE_URL ?>public/assets/img/products/shoes/3.jpg" alt="" class="lazy">
                        </figure>
                    </a>
                    <a href="#0">
            ...
            <div class="col-md-4">
                <div class="item_panel">
                    <a href="#0">
                        <figure>
                            <img src="<?= BASE_URL ?>public/assets/img/products/product_placeholder_square_small.jpg" data-src="<?= BASE_URL ?>public/assets/img/products/shoes/4.jpg" alt="" class="lazy">
                        </figure>
                    </a>
                    <a href="#0">
