...
<div id="carousel-home">
    <div class="owl-carousel owl-theme">
        <div class="owl-slide cover" style="background-image: url(<?= BASE_URL ?>public/assets/img/slides/slide_home_2.jpg);">
        ...
        <!--/owl-slide-->
        <div class="owl-slide cover" style="background-image: url(<?= BASE_URL ?>public/assets/img/slides/slide_home_1.jpg);">
            <div class="opacity-mask d-flex align-items-center" data-opacity-mask="rgba(0, 0, 0, 0.5)">
                <div class="container">
        ...
        <!--/owl-slide-->
        <div class="owl-slide cover" style="background-image: url(<?= BASE_URL ?>public/assets/img/slides/slide_home_3.jpg);">
...
<ul id="banners_grid" class="clearfix">
    <li>
        <a href="#0" class="img_container">
            <img src="<?= BASE_URL ?>public/assets/img/banners_cat_placeholder.jpg" data-src="<?= BASE_URL ?>public/assets/img/banner_1.jpg" alt="" class="lazy">
    ...
    <li>
        <a href="#0" class="img_container">
            <img src="<?= BASE_URL ?>public/assets/img/banners_cat_placeholder.jpg" data-src="<?= BASE_URL ?>public/assets/img/banner_2.jpg" alt="" class="lazy">
            <div class="short_info opacity-mask" data-opacity-mask="rgba(0, 0, 0, 0.5)">
    ...
    <li>
        <a href="#0" class="img_container">
            <img src="<?= BASE_URL ?>public/assets/img/banners_cat_placeholder.jpg" data-src="<?= BASE_URL ?>public/assets/img/banner_3.jpg" alt="" class="lazy">
            <div class="short_info opacity-mask" data-opacity-mask="rgba(0, 0, 0, 0.5)">
